...
import tw.north27.coachingapp.chat.chat.IWebSocketListener
import tw.north27.coachingapp.chat.chat.SocketResults
...
//class IChatRepository(val url: String, val okHttpUtil: OkHttpUtil) : CoroutineScope {
class ChatRepository(val okHttpUtil: OkHttpUtil) : IChatRepository, CoroutineScope {
