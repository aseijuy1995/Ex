...
fun OkHttpUtil.asyncGet(url: String, params: Map<String, String>? = null, callback: Callback) =
    async(get(url, params), callback)

fun OkHttpUtil.syncHead(url: String, params: Map<String, String>? = null) = sync(head(url, params))

fun OkHttpUtil.asyncHead(url: String, params: Map<String, String>? = null, callback: Callback) =
    async(head(url, params), callback)

fun OkHttpUtil.syncPost(url: String, params: Map<String, String>) =
    sync(post(url, mapToBody(params)))

fun OkHttpUtil.asyncPost(url: String, params: Map<String, String>, callback: Callback) =
    async(post(url, mapToBody(params)), callback)

fun OkHttpUtil.syncDelete(url: String, params: Map<String, String>) =
    sync(delete(url, mapToBody(params)))

fun OkHttpUtil.asyncDelete(url: String, params: Map<String, String>, callback: Callback) =
    async(delete(url, mapToBody(params)), callback)

fun OkHttpUtil.syncPut(url: String, params: Map<String, String>) = sync(put(url, mapToBody(params)))

fun OkHttpUtil.asyncPut(url: String, params: Map<String, String>, callback: Callback) =
    async(put(url, mapToBody(params)), callback)

fun OkHttpUtil.syncPatch(url: String, params: Map<String, String>) =
    sync(patch(url, mapToBody(params)))

fun OkHttpUtil.asyncPatch(url: String, params: Map<String, String>, callback: Callback) =
    async(patch(url, mapToBody(params)), callback)